...
\includegraphics[width=0.4\paperwidth]{figures/Motor.png}
\end{textblock*}

\begin{textblock*}{0.6\paperwidth}[1,1](\textwidth + \PraesentationSeitenrand, \textheight - \PraesentationSeitenrand)%
\includegraphics[width=0.6\paperwidth]{figures/Getriebe.png}
\end{textblock*}
...
\raggedleft%
\includegraphics[height=0.5\textheight]{figures/Motor.png}
\end{textblock*}
